 ...
 * PersonContact
 *
 * @ORM\Table(name="person_contact", indexes={@ORM\Index(name="fk_engineering_office_idx", columns={"engineering_office_id"}), @ORM\Index(name="fk_company_idx", columns={"company_id"})})
