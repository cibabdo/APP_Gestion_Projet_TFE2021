 ...
 * PlanningComment
 *
 * @ORM\Table(name="planning_history", indexes={@ORM\Index(name="fk_planning10_idx", columns={"planning_id"}), @ORM\Index(name="fk_user_idx", columns={"user_id"}), @ORM\Index(name="fk_project_idx", columns={"project_id"})})
