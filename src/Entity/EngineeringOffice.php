...
class EngineeringOffice
{
    ...
    /**
     * @var \EngineeringOfficeSort
     *
     * @ORM\ManyToOne(targetEntity="EngineeringOfficeSort")
     * @ORM\JoinColumns({
    ...
    public function getSort(): ?EngineeringOfficeSort
    {
        return $this->sort;
    }

    public function setSort(?EngineeringOfficeSort $sort): self
    {
        $this->sort = $sort;
