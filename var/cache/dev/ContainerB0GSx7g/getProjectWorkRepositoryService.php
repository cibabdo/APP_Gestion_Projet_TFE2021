 ...
 */
class getProjectWorkRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjectWorkRepository' shared autowired service.
     *
     * @return \App\Repository\ProjectWorkRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjectWorkRepository.php';

        return $container->privates['App\\Repository\\ProjectWorkRepository'] = new \App\Repository\ProjectWorkRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
