 ...
 */
class getCompanyActivityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompanyActivityRepository' shared autowired service.
     *
     * @return \App\Repository\CompanyActivityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompanyActivityRepository.php';

        return $container->privates['App\\Repository\\CompanyActivityRepository'] = new \App\Repository\CompanyActivityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
