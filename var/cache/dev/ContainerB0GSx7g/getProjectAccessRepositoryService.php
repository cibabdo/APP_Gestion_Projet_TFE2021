 ...
 */
class getProjectAccessRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjectAccessRepository' shared autowired service.
     *
     * @return \App\Repository\ProjectAccessRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjectAccessRepository.php';

        return $container->privates['App\\Repository\\ProjectAccessRepository'] = new \App\Repository\ProjectAccessRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
