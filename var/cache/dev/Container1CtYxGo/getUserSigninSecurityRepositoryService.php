 ...
 */
class getUserSigninSecurityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserSigninSecurityRepository' shared autowired service.
     *
     * @return \App\Repository\UserSigninSecurityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserSigninSecurityRepository.php';

        return $container->privates['App\\Repository\\UserSigninSecurityRepository'] = new \App\Repository\UserSigninSecurityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
