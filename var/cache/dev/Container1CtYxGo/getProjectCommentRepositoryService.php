 ...
 */
class getProjectCommentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjectCommentRepository' shared autowired service.
     *
     * @return \App\Repository\ProjectCommentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjectCommentRepository.php';

        return $container->privates['App\\Repository\\ProjectCommentRepository'] = new \App\Repository\ProjectCommentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
