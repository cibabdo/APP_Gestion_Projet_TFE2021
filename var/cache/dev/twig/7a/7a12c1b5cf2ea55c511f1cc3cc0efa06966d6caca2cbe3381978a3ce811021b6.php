...
class __TwigTemplate_e7c70aa9b6ab06aaf8e4e0fea5c6c1c0d79c42aae52a33d4241db634ef5531d5 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col text-center\">
        ...
        // line 17
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("planning_search");
        echo "\" data-target=\"#plannings\" placeholder=\"Nom de la tâche\" autofocus>        
        </div>   
        &nbsp;<a href=\"";
        // line 19
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("planning_new");
        echo "\" class=\"btn btn-primary btn-sm ml-5 add\">Ajouter</a>
    </div>
</div>
<div class=\"row\">
    <div class=\"col\">
        <div id=\"plannings\" class=\"d-flex flex-row  justify-content-center\" style=\"flex-wrap: wrap;\">
            ";
        // line 25
        $this->loadTemplate("planning/planning_list.html.twig", "planning/planning.html.twig", 25)->display($context);
        // line 26
        echo "        </div> 
    </div>
</div>
...
<div class=\"row mt-5\">
    <div class=\"col text-center\">
        ...
        <h2>Planning</h2>
        <div class=\"form-group inline\">
            <input type=\"text\" class=\"form-control\" id=\"search\" value=\"\" data-url=\"{{path('planning_search')}}\" data-target=\"#plannings\" placeholder=\"Nom de la tâche\" autofocus>        
        </div>   
        &nbsp;<a href=\"{{path('planning_new')}}\" class=\"btn btn-primary btn-sm ml-5 add\">Ajouter</a>
    </div>
</div>
<div class=\"row\">
    <div class=\"col\">
        <div id=\"plannings\" class=\"d-flex flex-row  justify-content-center\" style=\"flex-wrap: wrap;\">
            {% include ('planning/planning_list.html.twig') %}
        </div> 
    </div>
</div>
<script>
