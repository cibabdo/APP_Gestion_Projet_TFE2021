...
class __TwigTemplate_e95e0185e37c2590c113bbc4ac2e5874e8e454c3d6667008cfb32776f71cee30 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_navbar($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        $this->loadTemplate("navbar.html.twig", "department/department.html.twig", 4)->display($context);
    ...
    <div class=\"col text-center\">
        ...
        // line 17
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("department_search");
        echo "\" data-target=\"#departments\" placeholder=\"Nom du département\" autofocus>        
        </div>   
        &nbsp;<a href=\"";
        // line 19
...
<div class=\"row\">
    <div class=\"col\">
        <div id=\"departments\" class=\"d-flex flex-row  justify-content-center\" style=\"flex-wrap: wrap;\">
            ";
        // line 25
        $this->loadTemplate("department/department_list.html.twig", "department/department.html.twig", 25)->display($context);
        // line 26
        echo "        </div> 
    </div>
</div>
...
<div class=\"row mt-5\">
    <div class=\"col text-center\">
        ...
        <h2>Départements</h2>
        <div class=\"form-group inline\">
            <input type=\"text\" class=\"form-control\" id=\"search\" value=\"\" data-url=\"{{path('department_search')}}\" data-target=\"#departments\" placeholder=\"Nom du département\" autofocus>        
        </div>   
        &nbsp;<a href=\"{{path('department_new')}}\" class=\"btn btn-primary btn-sm ml-5 add\">Ajouter</a>
    </div>
</div>
<div class=\"row\">
    <div class=\"col\">
        <div id=\"departments\" class=\"d-flex flex-row  justify-content-center\" style=\"flex-wrap: wrap;\">
            {% include ('department/department_list.html.twig') %}
        </div> 
    </div>
</div>
<script>
...
", "department/department.html.twig", "C:\\xampp803\\htdocs\\symfony\\templates\\department\\department.html.twig");
    }
}
