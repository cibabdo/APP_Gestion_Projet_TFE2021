...
class __TwigTemplate_a163120765c7af53cf1ffb40ab879bcacc7d200635b72fb2e5c679119a9d2df6 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col\">
        ...
        // line 77
        echo "                <a href=\"";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("planning_list", ["id" => (isset($context["projectId"]) || array_key_exists("projectId", $context) ? $context["projectId"] : (function () { throw new RuntimeError('Variable "projectId" does not exist.', 77, $this->source); })())]), "html", null, true);
...
";
    ...
    {
        return array (  262 => 97,  255 => 93,  238 => 79,  232 => 77,  226 => 74,  217 => 69,  211 => 66,  206 => 64,  202 => 63,  194 => 59,  188 => 56,  183 => 54,  177 => 53,  169 => 49,  163 => 46,  158 => 44,  154 => 43,  146 => 39,  140 => 36,  135 => 34,  131 => 33,  123 => 29,  117 => 26,  112 => 24,  108 => 23,  100 => 19,  94 => 16,  89 => 14,  85 => 13,  79 => 10,  75 => 8,  68 => 7,  60 => 4,  53 => 3,  36 => 1,);
    }
        ...
        {{ form_start(form, {'attr' : {'autocomplete' : 'off'}}) }}
            ...
            <div class=\"my-2\">
                ...
                {% if form.vars.value.id %}           
                    <a href=\"#\" class=\"btn btn-danger ml-3\" onClick=\"deletePlanning()\">Supprimer</a>
                {% endif %}
                <a href=\"{{path('planning_list', {id:projectId})}}\" class=\"btn btn-secondary ml-3\">Retour</a>
            </div>            
        {{ form_end(form) }}
    </div>    
</div>
