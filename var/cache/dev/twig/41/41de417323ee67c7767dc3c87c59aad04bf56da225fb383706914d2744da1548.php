...
class __TwigTemplate_a79e344c5a58fde300debd0a7c32d8c5ccf14e149c57f47f3e6049da88229022 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col text-center\">
        ...
        // line 17
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("document_search", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 17, $this->source); })())]), "html", null, true);
        echo "\" data-target=\"#documents\" placeholder=\"Nom du document\" autofocus>        
        </div>   
        &nbsp;<a href=\"";
        // line 19
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("document_new", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 19, $this->source); })())]), "html", null, true);
...
<div class=\"row mt-5\">
    <div class=\"col text-center\">
        ...
        <div class=\"form-group inline\">
            <input type=\"text\" class=\"form-control\" id=\"search\" value=\"\" data-url=\"{{path('document_search', {id:id})}}\" data-target=\"#documents\" placeholder=\"Nom du document\" autofocus>        
        </div>   
        &nbsp;<a href=\"{{path('document_new', {id:id})}}\" class=\"btn btn-primary btn-sm ml-5 add\">Ajouter</a>
    </div>
</div>
<div class=\"row\">
    <div class=\"col\">
