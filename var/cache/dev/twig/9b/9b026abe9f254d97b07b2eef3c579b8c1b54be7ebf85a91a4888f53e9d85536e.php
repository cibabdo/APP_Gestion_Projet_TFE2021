...
class __TwigTemplate_6f538633a18d423a22af7f555e0fa5d670075330f0217490c208131519416ecf extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col\">       
        ...
        echo "
            ";
        // line 15
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 15, $this->source); })()), "brochure", [], "any", false, false, false, 15), 'row');
        echo "        
            ...
            <div class=\"my-2\">
                ...
                <a href=\"";
        // line 19
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("document_list", ["id" => (isset($context["projectId"]) || array_key_exists("projectId", $context) ? $context["projectId"] : (function () { throw new RuntimeError('Variable "projectId" does not exist.', 19, $this->source); })())]), "html", null, true);
...
";
    ...
    {
        return array (  103 => 22,  97 => 19,  90 => 15,  86 => 14,  79 => 10,  75 => 8,  68 => 7,  60 => 4,  53 => 3,  36 => 1,);
    }
