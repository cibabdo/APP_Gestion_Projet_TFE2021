...
/* company/company_edit.html.twig */
class __TwigTemplate_97d7d7428310c6d8359bd004f4f172963c5c9a1f77cbcdf0b7b433cbc3dd3cb5 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "company/company_edit.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "company/company_edit.html.twig", 1);
    ...
    public function block_navbar($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        $this->loadTemplate("navbar.html.twig", "company/company_edit.html.twig", 4)->display($context);
    ...
    function deleteCompany() {
        if (confirm('Confirmer la suppression ?')) {                    
            \$.ajax({
                url: '";
        // line 128
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("company_delete", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 128, $this->source); })())]), "html", null, true);
        echo "',
                type: 'DELETE',
                dataType: 'text',
...
";
    ...
    {
        return "company/company_edit.html.twig";
    }
        ...
        {{ form_start(form, {'attr' : {'autocomplete' : 'off'}}) }}
            ...
            <div class=\"my-2\">
                ...
                {% if form.vars.value.id %}           
                    <a href=\"#\" class=\"btn btn-danger ml-3\" onClick=\"deleteCompany()\">Supprimer</a>
                {% endif %}
                <a href=\"{{path('company_list')}}\" class=\"btn btn-secondary ml-3\">Retour</a>
            </div>            
        {{ form_end(form) }}
    </div>    
</div>
<script>
    ...
    function deleteCompany() {
        if (confirm('Confirmer la suppression ?')) {                    
            \$.ajax({
                url: '{{path(\"company_delete\",{id:id})}}',
                type: 'DELETE',
                dataType: 'text',
                success: function (result) {                    
                    document.location.href = '{{path(\"company_list\")}}?message=Entreprise supprimée'
                },
                error: function(jqXHR, textStatus, errorThrown ) {
                    console.log(jqXHR, textStatus, errorThrown)
                    alert('Erreur lors de la suppression')                    
...
{% endblock %}
", "company/company_edit.html.twig", "C:\\xampp803\\htdocs\\symfony\\templates\\company\\company_edit.html.twig");
    }
}
