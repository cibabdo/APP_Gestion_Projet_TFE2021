...
class __TwigTemplate_8e8b64fe43fea656dd581689873ab2dbf4330de975d60cc6e447a79fef029197 extends Template
{
    private $source;
    private $macros = [];
    ...
    function deleteDepartment() {
        if (confirm('Confirmer la suppression ?')) {                    
            \$.ajax({
                url: '";
        // line 42
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("department_delete", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 42, $this->source); })())]), "html", null, true);
        echo "',
                type: 'DELETE',
                dataType: 'text',
...
<div class=\"row mt-5\">
    <div class=\"col\">
        {{ form_start(form, {'attr' : {'autocomplete' : 'off'}}) }}
            <h1 class=\"text-center\">Département</h1>
            <div class=\"mb-3\">
                {{ form_label(form.name, 'Nom de du département', {'label_attr': { class: 'form-label' }}) }}
