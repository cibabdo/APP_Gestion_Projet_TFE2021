...
class __TwigTemplate_8d94f1da4c19aca4ed3ad615a78c8c5c66e9789aaa6f6fc05af256f69f72b768 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "document/document_upload.html.twig"));
    ...
    <div class=\"col\">       
        ...
        echo "    
            ...
            <div class=\"my-2\">
                ...
                <a href=\"";
        // line 34
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("project_edit", ["id" => (isset($context["projectId"]) || array_key_exists("projectId", $context) ? $context["projectId"] : (function () { throw new RuntimeError('Variable "projectId" does not exist.', 34, $this->source); })()), "onglet" => "document"]), "html", null, true);
...
";
    ...
    {
        return array (  153 => 37,  147 => 34,  139 => 30,  133 => 27,  128 => 25,  121 => 22,  115 => 19,  110 => 17,  106 => 16,  101 => 14,  94 => 10,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
<div class=\"row mt-5\">
    <div class=\"col\">       
        ...
        {{ form_start(form) }}
            ...
            <div class=\"my-2\">
                <button type=\"submit\" class=\"btn btn-primary\">Envoyer</button>
                <a href=\"{{path('project_edit',{id:projectId, onglet:'document'})}}\" class=\"btn btn-secondary ml-3\">Retour</a>
            </div>  
