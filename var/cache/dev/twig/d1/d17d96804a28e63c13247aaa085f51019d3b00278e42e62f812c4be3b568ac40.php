...
/* engineering_office_type/engineeringofficetype_edit.html.twig */
class __TwigTemplate_0bc2683101c42a4cdba45b0ad8a2ab8ee24bd0202f4beb072102c25ae137be9e extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "engineering_office_type/engineeringofficetype_edit.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "engineering_office_type/engineeringofficetype_edit.html.twig", 1);
    ...
    public function block_navbar($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        $this->loadTemplate("navbar.html.twig", "engineering_office_type/engineeringofficetype_edit.html.twig", 4)->display($context);
    ...
    <div class=\"col\">
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 23, $this->source); })()), "vars", [], "any", false, false, false, 23), "value", [], "any", false, false, false, 23), "id", [], "any", false, false, false, 23)) {
            echo "           
                    <a href=\"#\" class=\"btn btn-danger ml-3\" onClick=\"deleteEngineeringofficetype()\">Supprimer</a>
                ";
        }
        // line 26
        echo "                <a href=\"";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("engineeringofficetype_list");
...
<script>
    document.getElementById(\"engineering_office_type_name\").focus()    

    function deleteEngineeringofficetype() {
        if (confirm('Confirmer la suppression ?')) {                    
            \$.ajax({
                url: '";
        // line 37
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("engineeringofficetype_delete", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 37, $this->source); })())]), "html", null, true);
        echo "',
                type: 'DELETE',
                dataType: 'text',
...
";
    ...
    {
        return "engineering_office_type/engineeringofficetype_edit.html.twig";
    }
        ...
        {{ form_start(form, {'attr' : {'autocomplete' : 'off'}}) }}
            ...
            <div class=\"my-2\">
                ...
                {% if form.vars.value.id %}           
                    <a href=\"#\" class=\"btn btn-danger ml-3\" onClick=\"deleteEngineeringofficetype()\">Supprimer</a>
                {% endif %}
                <a href=\"{{path('engineeringofficetype_list')}}\" class=\"btn btn-secondary ml-3\">Retour</a>
            </div>            
        {{ form_end(form) }}
    </div>    
</div>
<script>
    ...
    function deleteEngineeringofficetype() {
        if (confirm('Confirmer la suppression ?')) {                    
            \$.ajax({
                url: '{{path(\"engineeringofficetype_delete\",{id:id})}}',
                type: 'DELETE',
                dataType: 'text',
                success: function (result) {                    
                    document.location.href = '{{path(\"engineeringofficetype_list\")}}?message=Type de bureau supprimé'
                },
                error: function(jqXHR, textStatus, errorThrown ) {
                    console.log(jqXHR, textStatus, errorThrown)
                    alert('Erreur lors de la suppression')                    
...
{% endblock %}
", "engineering_office_type/engineeringofficetype_edit.html.twig", "C:\\xampp803\\htdocs\\symfony\\templates\\engineering_office_type\\engineeringofficetype_edit.html.twig");
    }
}
