...
/* company/company-edit.html.twig */
class __TwigTemplate_a233baf713890fca8bb608418fd04be33f6fd65d0b6b384958eea73301a12f7a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "company/company-edit.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "company/company-edit.html.twig", 1);
    ...
    public function block_navbar($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        $this->loadTemplate("navbar.html.twig", "company/company-edit.html.twig", 4)->display($context);
    ...
    <div class=\"col\">
        ...
        echo "
            <h1 class=\"text-center\">Entreprise</h1>
            <div class=\"mb-3\">
                ";
        // line 13
        ...
        echo "    
            ...
            <div class=\"mb-3\">
                ";
        // line 23
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 23, $this->source); })()), "activity", [], "any", false, false, false, 23), 'label', ["label_attr" => ["class" => "form-label"], "label" => "Activité d'entreprise"]);
        echo "
                ";
        // line 24
        if ($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 24, $this->source); })()), "activity", [], "any", false, false, false, 24), 'errors')) {
            echo "            
                    <div class=\"form-error text-danger\">
                        <span class=\"span_error bg-danger text-white\">ERREUR</span>&nbsp;";
            // line 26
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 26, $this->source); })()), "activity", [], "any", false, false, false, 26), 'errors');
            echo "
                    </div>            
                ";
        }
        // line 29
        echo "                ";
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 29, $this->source); })()), "activity", [], "any", false, false, false, 29), 'widget', ["attr" => ["class" => "form-control"]]);
        echo "    
            </div>  
        ...
        echo "    
            ...
            <div class=\"form-success\">
                ";
        // line 113
        echo twig_escape_filter($this->env, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 113, $this->source); })()), "html", null, true);
        echo "
            </div>
            ...
            <div class=\"my-2\">
                ...
                ";
        // line 118
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 118, $this->source); })()), "vars", [], "any", false, false, false, 118), "value", [], "any", false, false, false, 118), "id", [], "any", false, false, false, 118)) {
            echo "           
                    <a href=\"#\" class=\"btn btn-danger ml-3\" onClick=\"deleteCompany()\">Supprimer</a>
                ";
        }
        // line 121
        echo "                <a href=\"";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("company-list");
    ...
    function deleteCompany() {
        if (confirm('Confirmer la suppression ?')) {                    
            \$.ajax({
                url: '";
        // line 132
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("company-delete", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 132, $this->source); })())]), "html", null, true);
        echo "',
                type: 'DELETE',
                dataType: 'text',
        ...
        // line 136
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("company-list");
        echo "?message=Entreprise supprimée'
                },
...
";
    ...
    {
        return "company/company-edit.html.twig";
    }
...
<div class=\"row mt-5\">
    <div class=\"col\">
        {{ form_start(form, {'attr' : {'autocomplete' : 'off'}}) }}
            <h1 class=\"text-center\">Entreprise</h1>
            <div class=\"mb-3\">
                {{ form_label(form.name, 'Nom de l\\'entreprise', {'label_attr': { class: 'form-label' }}) }}
            ...
            <div class=\"mb-3\">
                {{ form_label(form.activity, 'Activité d\\'entreprise', {'label_attr': { class: 'form-label' }}) }}
                {% if form_errors(form.activity) %}            
                    <div class=\"form-error text-danger\">
                        <span class=\"span_error bg-danger text-white\">ERREUR</span>&nbsp;{{ form_errors(form.activity) }}
                    </div>            
                {% endif %}
            ...
            <div class=\"my-2\">
                ...
                {% if form.vars.value.id %}           
                    <a href=\"#\" class=\"btn btn-danger ml-3\" onClick=\"deleteCompany()\">Supprimer</a>
                {% endif %}
                <a href=\"{{path('company-list')}}\" class=\"btn btn-secondary ml-3\">Retour</a>
            </div>            
        {{ form_end(form) }}
    </div>    
</div>
<script>
    ...
    function deleteCompany() {
        if (confirm('Confirmer la suppression ?')) {                    
            \$.ajax({
                url: '{{path(\"company-delete\",{id:id})}}',
                type: 'DELETE',
                dataType: 'text',
                success: function (result) {                    
                    document.location.href = '{{path(\"company-list\")}}?message=Entreprise supprimée'
                },
                error: function(jqXHR, textStatus, errorThrown ) {
                    console.log(jqXHR, textStatus, errorThrown)
                    alert('Erreur lors de la suppression')                    
...
{% endblock %}
", "company/company-edit.html.twig", "C:\\xampp803\\htdocs\\symfony\\templates\\company\\company-edit.html.twig");
    }
}
