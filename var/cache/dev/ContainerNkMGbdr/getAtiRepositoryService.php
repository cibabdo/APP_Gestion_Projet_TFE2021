 ...
 */
class getAtiRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AtiRepository' shared autowired service.
     *
     * @return \App\Repository\AtiRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AtiRepository.php';

        return $container->privates['App\\Repository\\AtiRepository'] = new \App\Repository\AtiRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
