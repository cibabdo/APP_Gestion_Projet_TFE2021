 ...
 */
class getEngineeringOfficeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EngineeringOfficeRepository' shared autowired service.
     *
     * @return \App\Repository\EngineeringOfficeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EngineeringOfficeRepository.php';

        return $container->privates['App\\Repository\\EngineeringOfficeRepository'] = new \App\Repository\EngineeringOfficeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
