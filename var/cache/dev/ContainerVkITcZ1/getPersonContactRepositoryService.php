 ...
 */
class getPersonContactRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PersonContactRepository' shared autowired service.
     *
     * @return \App\Repository\PersonContactRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PersonContactRepository.php';

        return $container->privates['App\\Repository\\PersonContactRepository'] = new \App\Repository\PersonContactRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
