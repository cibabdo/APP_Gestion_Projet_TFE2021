 ...
 */
class getEngineeringOfficeSortRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EngineeringOfficeSortRepository' shared autowired service.
     *
     * @return \App\Repository\EngineeringOfficeSortRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EngineeringOfficeSortRepository.php';

        return $container->privates['App\\Repository\\EngineeringOfficeSortRepository'] = new \App\Repository\EngineeringOfficeSortRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
