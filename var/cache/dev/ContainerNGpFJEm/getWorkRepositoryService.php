 ...
 */
class getWorkRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WorkRepository' shared autowired service.
     *
     * @return \App\Repository\WorkRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WorkRepository.php';

        return $container->privates['App\\Repository\\WorkRepository'] = new \App\Repository\WorkRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
